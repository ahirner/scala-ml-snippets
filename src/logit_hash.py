# Original implementation of the logistic regression from:
# https://www.kaggle.com/c/criteo-display-ad-challenge/forums/t/10322/beat-the-benchmark-with-less-then-200mb-of-memory/53674
# Reworked to work with off the shelf data files provided by criteo (no column headers, just tsv)

# Idea: round off ints to reduce hash variance
